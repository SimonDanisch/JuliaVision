"""
ProPainter is **not ported yet**, so this asserts the contract that state has: the
...
@testset "ProPainterRunner" begin
    ...
    err = try; ProPainterRunner.assetdir(); nothing; catch e; e; end
    ...
    @test_throws ErrorException ProPainterRunner.propaintergraph()
end
