"""
BasicVSR++ is **not ported yet**, so this asserts the contract that state has: the
...
@testset "BasicVSRRunner" begin
    ...
    @test BasicVSRRunner.ready() === false
    ...
    err = try; BasicVSRRunner.assetdir(); nothing; catch e; e; end
    ...
    @test_throws ErrorException BasicVSRRunner.basicvsrppgraph()
end
