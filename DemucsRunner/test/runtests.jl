"""
Demucs v4 (htdemucs) is **not ported yet**, so this asserts the contract that state has: the
...
@testset "DemucsRunner" begin
    ...
    err = try; DemucsRunner.assetdir(); nothing; catch e; e; end
    ...
    @test_throws ErrorException DemucsRunner.demucsgraph()
end
