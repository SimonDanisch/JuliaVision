"""
Whisper large-v3-turbo is **not ported yet**, so this asserts the contract that state has: the
...
@testset "WhisperRunner" begin
    ...
    @test WhisperRunner.ready() === false
    ...
    err = try; WhisperRunner.assetdir(); nothing; catch e; e; end
    ...
    @test_throws ErrorException WhisperRunner.whispergraph()
end
